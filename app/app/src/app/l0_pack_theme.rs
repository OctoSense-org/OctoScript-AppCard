...
fn packs() -> &'static BTreeMap<&'static str, Value> {
    ...
    PACKS.get_or_init(|| {
        [
            ("atro", include_str!("../../../../splash-makepad/components/l0/native/atro/tokens.json")),
            ("atro_light", include_str!("../../../../splash-makepad/components/l0/native/atro_light/tokens.json")),
            ("camo", include_str!("../../../../splash-makepad/components/l0/native/camo/tokens.json")),
            ("camo_light", include_str!("../../../../splash-makepad/components/l0/native/camo_light/tokens.json")),
            ("taskplan_light", include_str!("../../../../splash-makepad/components/l0/native/taskplan_light/tokens.json")),
