...
KEY = Path("/private/tmp/claude-501/-Users-user-home-Splash/10acdae2-9f20-4e60-b7b1-7195c1bdb439/scratchpad/oai_key").read_text().strip()
...
CONSTRUCTORS = Path("~/home/Splash/docs/ui-l0-constructors.toml").read_text()
