...
IMG = pathlib.Path('/private/tmp/claude-501/-Users-user-home-Splash/df6c4ec5-2002-4e8f-84de-7d846576918e/scratchpad/atro/src/images')
s = socket.socket()
...
s.close()
t0 = time.time()
todo = [d for d in sorted(pathlib.Path('frozen2').glob('*.dsl'))
