// FROZEN compile of ⟶ [Alerts] View #1 — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 375.0 height: 65.0 margin: Inset{left: 0.0 right: 0 top: 672.0 bottom: 0} draw_bg.color: #4c5fefff }
    RoundedView{ width: 24.0 height: 34.6 margin: Inset{left: 341.0 right: 0 top: 687.1 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 315.0 height: 32.5 margin: Inset{left: 20.0 right: 0 top: 692.2 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fill height: Fit text: "Your device is not connect to internet, please make sure your connection is working." draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.1 } } }
