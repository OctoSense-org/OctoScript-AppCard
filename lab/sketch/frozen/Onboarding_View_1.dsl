// FROZEN compile of ⟶ [Onboarding] View #1 — spec2dsl.py.
// A poster, not an app: no roles, no data, no theme.
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    RoundedView{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} draw_bg.color: #645affff draw_bg.color_2: #a573ffff draw_bg.gradient_fill_horizontal: 1.0 }
    RoundedShadowView{ width: 173.0 height: 205.0 margin: Inset{left: 67.0 right: 0 top: 235.5 bottom: 0} draw_bg.shadow_color: #4162a93c draw_bg.shadow_radius: 41.5 draw_bg.shadow_offset: vec2(-13.5, 11.5) draw_bg.color: #ffffffeb draw_bg.border_radius: 34.6 }
    RoundedShadowView{ width: 194.5 height: 231.0 margin: Inset{left: 87.0 right: 0 top: 223.0 bottom: 0} draw_bg.shadow_color: #4162a93c draw_bg.shadow_radius: 41.5 draw_bg.shadow_offset: vec2(-13.5, 11.5) draw_bg.color: #ffffffeb draw_bg.border_radius: 38.9 }
    RoundedShadowView{ width: 216.0 height: 256.5 margin: Inset{left: 107.0 right: 0 top: 210.0 bottom: 0} draw_bg.shadow_color: #4162a93c draw_bg.shadow_radius: 41.5 draw_bg.shadow_offset: vec2(-13.5, 11.5) draw_bg.color: #ffffffeb draw_bg.border_radius: 43.2 }
    RoundedView{ width: 128.8 height: 95.7 margin: Inset{left: 141.7 right: 0 top: 277.9 bottom: 0} draw_bg.color: #e0e2ffeb draw_bg.border_radius: 19.1 }
    RoundedView{ width: 11.6 height: 11.6 margin: Inset{left: 258.9 right: 0 top: 361.9 bottom: 0} draw_bg.color: #e0e2ffeb draw_bg.border_radius: 2.3 }
    RoundedView{ width: 12.3 height: 12.3 margin: Inset{left: 141.7 right: 0 top: 345.1 bottom: 0} draw_bg.color: #e0e2ffeb draw_bg.border_radius: 2.5 }
    RoundedView{ width: 16.4 height: 16.4 margin: Inset{left: 229.8 right: 0 top: 277.9 bottom: 0} draw_bg.color: #e0e2ffeb draw_bg.border_radius: 3.3 }
    RoundedView{ width: 62.8 height: 72.0 margin: Inset{left: 178.9 right: 0 top: 303.9 bottom: 0} draw_bg.color: #e6e9ffeb draw_bg.border_radius: 12.6 draw_bg.border_size: 1.5 draw_bg.border_color: #828ff4ff }
    RoundedView{ width: 20.9 height: 21.4 margin: Inset{left: 219.2 right: 0 top: 304.6 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 4.2 draw_bg.border_size: 1.5 draw_bg.border_color: #7e86eeff }
    RoundedView{ width: 71.5 height: 12.6 margin: Inset{left: 203.7 right: 0 top: 348.1 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 2.5 draw_bg.border_size: 1.5 draw_bg.border_color: #7e86eeff }
    RoundedView{ width: 200.0 height: 50.0 margin: Inset{left: 87.5 right: 0 top: 687.0 bottom: 0} draw_bg.color: #4c5fefff draw_bg.border_radius: 25.0 }
    RoundedView{ width: 32.0 height: 24.0 margin: Inset{left: 232.2 right: 0 top: 700.0 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 146.7 height: 16.0 margin: Inset{left: 110.8 right: 0 top: 707.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "get started" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 162.5 right: 0 top: 652.5 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 208.0 right: 0 top: 652.5 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 192.5 right: 0 top: 652.5 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 5.5 height: 5.5 margin: Inset{left: 177.0 right: 0 top: 652.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.8 }
