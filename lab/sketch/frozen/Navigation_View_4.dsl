...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 18.9 height: 18.9 margin: Inset{left: 178.1 right: 0 top: 700.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 11.8 height: 11.8 margin: Inset{left: 181.6 right: 0 top: 703.6 bottom: 0} draw_bg.color: #50a1ffff }
    ...
    RoundedView{ width: 36.0 height: 24.0 margin: Inset{left: 169.5 right: 0 top: 499.0 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 165.0 height: 16.0 margin: Inset{left: 121.5 right: 0 top: 506.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Bookmarks" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    RoundedView{ width: 36.0 height: 24.0 margin: Inset{left: 169.5 right: 0 top: 549.5 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 165.0 height: 16.0 margin: Inset{left: 121.5 right: 0 top: 556.5 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Gallery" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    RoundedView{ width: 36.0 height: 24.0 margin: Inset{left: 169.5 right: 0 top: 600.0 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 165.0 height: 16.0 margin: Inset{left: 121.5 right: 0 top: 607.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Settings" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    RoundedView{ width: 36.0 height: 24.0 margin: Inset{left: 169.5 right: 0 top: 449.0 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 165.0 height: 16.0 margin: Inset{left: 121.5 right: 0 top: 456.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Trending" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    RoundedView{ width: 36.0 height: 24.0 margin: Inset{left: 169.5 right: 0 top: 399.0 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 165.0 height: 16.0 margin: Inset{left: 121.5 right: 0 top: 406.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Messages" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
}
