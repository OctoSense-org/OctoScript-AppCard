...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 45.0 height: 45.0 margin: Inset{left: 162.5 right: 0 top: 467.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 301.0 right: 0 top: 412.0 bottom: 0} draw_bg.color: #1c8ff856 }
    ...
    RoundedView{ width: 51.2 height: 28.8 margin: Inset{left: 159.4 right: 0 top: 712.6 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 234.7 height: 18.0 margin: Inset{left: 91.2 right: 0 top: 721.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Continue ➝" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    RoundedView{ width: 45.0 height: 45.0 margin: Inset{left: 497.5 right: 0 top: 487.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 636.0 right: 0 top: 457.0 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 290.0 height: 75.5 margin: Inset{left: 380.0 right: 0 top: 602.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "The rule of thirds states that an image is most pleasing when its subjects or regions are ..." draw_text.color: #6c7b8aff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.4 } } }
    View{ width: 166.9 height: 16.0 margin: Inset{left: 453.5 right: 0 top: 577.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Rule of thirds" draw_text.color: #140f26ff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
