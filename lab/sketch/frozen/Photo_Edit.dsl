// FROZEN compile of ⟶ [Photo] Edit — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 355.0 height: 610.0 margin: Inset{left: 10.0 right: 0 top: 88.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 10.0 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 61.0 right: 0 top: 728.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 137.5 right: 0 top: 728.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 214.0 right: 0 top: 728.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 290.5 right: 0 top: 728.0 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 161.5 height: 45.0 margin: Inset{left: 106.8 right: 0 top: 608.0 bottom: 0} draw_bg.color: #140f2680 draw_bg.border_radius: 22.5 }
    RoundedView{ width: 18.1 height: 24.0 margin: Inset{left: 238.9 right: 0 top: 618.5 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 105.5 height: 16.0 margin: Inset{left: 121.8 right: 0 top: 625.5 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Added to favorites" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 6.2 } } }
