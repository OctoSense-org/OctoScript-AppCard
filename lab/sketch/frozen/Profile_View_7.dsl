...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 27.5 height: 30.0 margin: Inset{left: 62.6 right: 0 top: 641.5 bottom: 0} draw_bg.color: #ffffff5e draw_bg.border_radius: 5.5 }
    RoundedView{ width: 27.5 height: 30.0 margin: Inset{left: 35.0 right: 0 top: 641.5 bottom: 0} draw_bg.color: #ffffff5e draw_bg.border_radius: 5.5 }
    RoundedView{ width: 27.5 height: 30.0 margin: Inset{left: 90.1 right: 0 top: 641.5 bottom: 0} draw_bg.color: #ffffff5e draw_bg.border_radius: 5.5 }
    RoundedView{ width: 27.5 height: 30.0 margin: Inset{left: 117.8 right: 0 top: 641.5 bottom: 0} draw_bg.color: #ffffff5e draw_bg.border_radius: 5.5 }
    ...
    View{ width: 223.7 height: 14.0 margin: Inset{left: 128.6 right: 0 top: 718.5 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "follow Oluchi" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    View{ width: 161.9 height: 21.0 margin: Inset{left: 35.0 right: 0 top: 553.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Interaction Designer" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 } } }
