...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 50.0 height: 25.5 margin: Inset{left: 162.5 right: 0 top: 201.5 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 19.9 height: 8.0 margin: Inset{left: 177.4 right: 0 top: 213.2 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 1.6 }
    RoundedView{ width: 12.5 height: 2.6 margin: Inset{left: 176.8 right: 0 top: 215.8 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 1.3 }
    RoundedView{ width: 12.5 height: 2.6 margin: Inset{left: 185.5 right: 0 top: 215.8 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 1.3 }
