...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 22.3 height: 22.3 margin: Inset{left: 176.3 right: 0 top: 694.9 bottom: 0} draw_bg.color: #1c8ff856 }
    RoundedView{ width: 13.9 height: 13.9 margin: Inset{left: 180.6 right: 0 top: 699.0 bottom: 0} draw_bg.color: #50a1ffff }
    ...
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 175.5 right: 0 top: 694.0 bottom: 0} draw_bg.color: #1c8ff856 }
    ...
    RoundedView{ width: 15.7 height: 15.0 margin: Inset{left: 195.3 right: 0 top: 55.5 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 50.0 height: 15.0 margin: Inset{left: 166.7 right: 0 top: 58.5 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Live" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-SemiBold.ttf") asc: 0.0 desc: 0.0 } } font_size: 5.6 } } }
    RoundedView{ width: 200.0 height: 47.0 margin: Inset{left: 87.5 right: 0 top: 602.5 bottom: 0} draw_bg.color: #140f2675 draw_bg.border_radius: 9.4 }
    View{ width: 176.7 height: 22.0 margin: Inset{left: 104.2 right: 0 top: 615.5 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "Tap and hold to go live" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 6.2 } } }
