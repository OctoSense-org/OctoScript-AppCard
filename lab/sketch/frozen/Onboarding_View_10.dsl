// FROZEN compile of  ⟶ [Onboarding] View #10 — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} draw_bg.color: #17212dff }
    RoundedView{ width: 147.0 height: 47.5 margin: Inset{left: 114.0 right: 0 top: 293.0 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 9.5 }
    RoundedView{ width: 20.0 height: 17.6 margin: Inset{left: 272.5 right: 0 top: 295.0 bottom: 0} draw_bg.color: #140f2693 draw_bg.border_radius: 2.2 }
    RoundedView{ width: 3.5 height: 8.8 margin: Inset{left: 272.5 right: 0 top: 308.2 bottom: 0} draw_bg.color: #140f2693 }
    RoundedView{ width: 20.0 height: 22.0 margin: Inset{left: 272.5 right: 0 top: 295.0 bottom: 0} draw_bg.color: #140f2675 draw_bg.border_radius: 4.0 }
    RoundedView{ width: 20.0 height: 17.6 margin: Inset{left: 272.5 right: 0 top: 295.0 bottom: 0} draw_bg.color: #140f2693 draw_bg.border_radius: 2.2 }
    RoundedView{ width: 3.5 height: 8.8 margin: Inset{left: 272.5 right: 0 top: 308.2 bottom: 0} draw_bg.color: #140f2693 }
    View{ width: 40.9 height: 15.7 margin: Inset{left: 274.1 right: 0 top: 298.9 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "UI" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 5.6 } } }
    RoundedView{ width: 375.0 height: 485.0 margin: Inset{left: 0.0 right: 0 top: 327.0 bottom: 0} draw_bg.color: #ffffff00 draw_bg.color_2: #000000ff }
    RoundedView{ width: 375.0 height: 485.0 margin: Inset{left: 0.0 right: 0 top: 327.0 bottom: 0} draw_bg.color: #00000097 draw_bg.border_radius: 75.0 }
    RoundedView{ width: 375.0 height: 105.0 margin: Inset{left: 0.0 right: 0 top: 707.0 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 21.0 }
    RoundedView{ width: 375.0 height: 68.0 margin: Inset{left: 0.0 right: 0 top: 744.0 bottom: 0} draw_bg.color: #d8d8d8ff }
    RoundedView{ width: 375.0 height: 37.0 margin: Inset{left: 0.0 right: 0 top: 707.0 bottom: 0} draw_bg.color: #131315eb draw_bg.border_radius: 7.4 }
    RoundedView{ width: 37.5 height: 37.0 margin: Inset{left: 337.4 right: 0 top: 707.0 bottom: 0} draw_bg.color: #131315eb draw_bg.border_radius: 7.4 }
    RoundedView{ width: 37.5 height: 37.0 margin: Inset{left: 0.0 right: 0 top: 707.0 bottom: 0} draw_bg.color: #131315eb draw_bg.border_radius: 7.4 }
    View{ width: 141.9 height: 16.0 margin: Inset{left: 130.8 right: 0 top: 767.5 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Explore the demo" draw_text.color: #6c7b8aff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 } } }
    RoundedView{ width: 4.8 height: 4.5 margin: Inset{left: 161.0 right: 0 top: 531.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.8 height: 4.5 margin: Inset{left: 209.2 right: 0 top: 531.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.8 height: 4.5 margin: Inset{left: 192.8 right: 0 top: 531.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 5.8 height: 5.5 margin: Inset{left: 176.3 right: 0 top: 530.5 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.8 }
    View{ width: 320.0 height: 53.0 margin: Inset{left: 32.5 right: 0 top: 587.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "The rule of thirds states that an image is most pleasing when its subjects or regions are ..." draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.4 } } }
    RoundedView{ width: 305.0 height: 50.0 margin: Inset{left: 35.0 right: 0 top: 662.0 bottom: 0} draw_bg.color: #4c5fefff draw_bg.border_radius: 25.0 }
    View{ width: 223.7 height: 16.0 margin: Inset{left: 98.0 right: 0 top: 682.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "create account" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    View{ width: 166.9 height: 16.0 margin: Inset{left: 121.0 right: 0 top: 562.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Rule of thirds" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
