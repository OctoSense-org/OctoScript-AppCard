...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 150.3 height: 85.2 margin: Inset{left: 92.7 right: 0 top: 366.9 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 17.0 }
    RoundedView{ width: 11.6 height: 11.6 margin: Inset{left: 231.4 right: 0 top: 440.4 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 2.3 }
    RoundedView{ width: 12.3 height: 12.3 margin: Inset{left: 92.7 right: 0 top: 418.1 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 2.5 }
    RoundedView{ width: 16.4 height: 16.4 margin: Inset{left: 138.3 right: 0 top: 366.9 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 3.3 }
    RoundedView{ width: 9.7 height: 33.0 margin: Inset{left: 182.7 right: 0 top: 433.5 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 1.9 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 68.5 height: 44.0 margin: Inset{left: 158.4 right: 0 top: 393.9 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 8.8 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 33.0 height: 44.0 margin: Inset{left: 141.8 right: 0 top: 393.9 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 6.6 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 42.7 height: 5.0 margin: Inset{left: 132.5 right: 0 top: 432.9 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 1.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 25.4 height: 37.0 margin: Inset{left: 204.1 right: 0 top: 374.6 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 5.1 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 23.7 height: 14.8 margin: Inset{left: 151.5 right: 0 top: 411.4 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 3.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 23.7 height: 14.8 margin: Inset{left: 151.5 right: 0 top: 406.9 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 3.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    ...
    RoundedView{ width: 46.8 height: 24.0 margin: Inset{left: 161.8 right: 0 top: 664.0 bottom: 0} draw_bg.color: #50a1ffff }
    View{ width: 214.5 height: 16.0 margin: Inset{left: 99.5 right: 0 top: 671.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Try again..." draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
