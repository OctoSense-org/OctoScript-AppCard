// FROZEN compile of ⟶ [Alerts] View #10 — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 321.0 right: 0 top: 277.0 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 131.2 height: 21.0 margin: Inset{left: 132.8 right: 0 top: 712.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Remind me later" draw_text.color: #6e7982ff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 } } }
    ...
    RoundedView{ width: 46.8 height: 24.0 margin: Inset{left: 70.2 right: 0 top: 664.0 bottom: 0} draw_bg.color: #1c8ff856 }
    View{ width: 214.5 height: 16.0 margin: Inset{left: 128.7 right: 0 top: 671.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Allow camera" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    View{ width: 310.0 height: 78.0 margin: Inset{left: 37.5 right: 0 top: 567.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "You will be able to easily upload and capture your profile picture" draw_text.color: #6c7b8aff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.4 } } }
    View{ width: 239.5 height: 58.0 margin: Inset{left: 73.5 right: 0 top: 502.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "Find that one picture you love" draw_text.color: #140f26ff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-SemiBold.ttf") asc: 0.0 desc: 0.0 } } font_size: 12.4 } } }
    RoundedView{ width: 143.6 height: 75.1 margin: Inset{left: 114.8 right: 0 top: 371.1 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 15.0 }
    RoundedView{ width: 10.9 height: 10.9 margin: Inset{left: 114.8 right: 0 top: 435.3 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 2.2 }
    RoundedView{ width: 18.2 height: 18.2 margin: Inset{left: 240.2 right: 0 top: 413.1 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 3.6 }
    RoundedView{ width: 12.7 height: 12.7 margin: Inset{left: 129.2 right: 0 top: 371.1 bottom: 0} draw_bg.color: #d5edf1eb draw_bg.border_radius: 2.5 }
    RoundedView{ width: 64.8 height: 70.0 margin: Inset{left: 166.0 right: 0 top: 377.3 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 13.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 51.0 height: 50.0 margin: Inset{left: 173.0 right: 0 top: 383.8 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 10.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 24.1 height: 10.1 margin: Inset{left: 175.2 right: 0 top: 408.5 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 2.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 64.8 height: 70.0 margin: Inset{left: 142.4 right: 0 top: 397.2 bottom: 0} draw_bg.color: #ffffffeb draw_bg.border_radius: 13.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 51.0 height: 50.0 margin: Inset{left: 149.4 right: 0 top: 403.7 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 10.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 12.8 height: 12.8 margin: Inset{left: 162.8 right: 0 top: 411.6 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 6.4 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 24.1 height: 10.1 margin: Inset{left: 151.6 right: 0 top: 428.4 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 2.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
    RoundedView{ width: 30.4 height: 15.1 margin: Inset{left: 169.1 right: 0 top: 430.0 bottom: 0} draw_bg.color: #eefafceb draw_bg.border_radius: 3.0 draw_bg.border_size: 1.5 draw_bg.border_color: #a3bfc6ff }
