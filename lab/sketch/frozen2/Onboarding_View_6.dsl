...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 75.0 height: 75.0 margin: Inset{left: 147.5 right: 0 top: 452.0 bottom: 0} draw_bg.color: #45e994ff draw_bg.color_2: #23bcbaff draw_bg.border_radius: 7.5 }
    RoundedView{ width: 45.0 height: 45.0 margin: Inset{left: 162.5 right: 0 top: 467.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 29.0 height: 21.0 margin: Inset{left: 170.5 right: 0 top: 479.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/87403908172ec628.png") }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 301.0 right: 0 top: 412.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 308.5 right: 0 top: 419.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/9df0afcdb0e82232.png") }
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 308.5 right: 0 top: 419.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/942271a300050bdc.png") }
    ...
    RoundedView{ width: 75.0 height: 75.0 margin: Inset{left: 482.5 right: 0 top: 472.0 bottom: 0} draw_bg.color: #645affff draw_bg.color_2: #a573ffff draw_bg.gradient_fill_horizontal: 1.0 draw_bg.border_radius: 37.5 }
    RoundedView{ width: 45.0 height: 45.0 margin: Inset{left: 497.5 right: 0 top: 487.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 21.0 height: 3.2 margin: Inset{left: 509.5 right: 0 top: 516.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/b35d9b85192648fe.png") }
    Image{ width: 21.0 height: 26.0 margin: Inset{left: 509.5 right: 0 top: 496.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/294edb3ec949e704.png") }
    RoundedView{ width: 24.0 height: 24.0 margin: Inset{left: 636.0 right: 0 top: 457.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 643.5 right: 0 top: 464.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/9df0afcdb0e82232.png") }
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 643.5 right: 0 top: 464.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/942271a300050bdc.png") }
