...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 328.5 right: 0 top: 334.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/9df0afcdb0e82232.png") }
    Image{ width: 9.5 height: 9.5 margin: Inset{left: 328.5 right: 0 top: 334.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/942271a300050bdc.png") }
    RoundedView{ width: 110.7 height: 261.6 margin: Inset{left: 128.7 right: 0 top: 304.0 bottom: 0} draw_bg.color: #ecf0f5ff draw_bg.color_2: #ccd6e6ff draw_bg.border_radius: 22.1 }
    ...
    RoundedView{ width: 109.0 height: 7.8 margin: Inset{left: 129.4 right: 0 top: 358.6 bottom: 0} draw_bg.color: #ffffffcd draw_bg.color_2: #ffffff35 draw_bg.border_radius: 1.6 }
    RoundedView{ width: 109.0 height: 10.5 margin: Inset{left: 129.4 right: 0 top: 355.9 bottom: 0} draw_bg.color: #ffffffcd draw_bg.color_2: #ffffff35 draw_bg.border_radius: 5.2 }
    RoundedView{ width: 129.0 height: 152.5 margin: Inset{left: 119.2 right: 0 top: 358.6 bottom: 0} draw_bg.color: #ffffffcd draw_bg.color_2: #ffffff35 draw_bg.border_radius: 22.2 }
    RoundedView{ width: 79.0 height: 84.0 margin: Inset{left: 147.8 right: 0 top: 395.2 bottom: 0} draw_bg.color: #e83f94ff draw_bg.color_2: #f54e5eff draw_bg.border_radius: 15.8 }
    RoundedView{ width: 104.0 height: 110.5 margin: Inset{left: 135.5 right: 0 top: 382.0 bottom: 0} draw_bg.color: #e83f94ff draw_bg.color_2: #f54e5eff draw_bg.border_radius: 20.8 }
    Image{ width: 57.0 height: 60.5 margin: Inset{left: 159.0 right: 0 top: 407.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/7ce7e5fae3e70495.png") }
    RoundedView{ width: 45.0 height: 45.0 margin: Inset{left: 165.0 right: 0 top: 415.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 26.0 height: 23.0 margin: Inset{left: 174.5 right: 0 top: 426.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/77d2a74cad68b079.png") }
    ...
    Image{ width: 14.1 height: 17.5 margin: Inset{left: 254.6 right: 0 top: 698.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/1100cd74d823da24.png") }
