// FROZEN compile of ⟶ [Profile] View #7 — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} draw_bg.color: #000000ff }
    RoundedView{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} draw_bg.color: #00000000 draw_bg.color_2: #00000080 }
    Image{ width: 27.5 height: 30.0 margin: Inset{left: 62.6 right: 0 top: 641.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/511824e50f7c4849.png") }
    Image{ width: 27.5 height: 30.0 margin: Inset{left: 35.0 right: 0 top: 641.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/511824e50f7c4849.png") }
    Image{ width: 27.5 height: 30.0 margin: Inset{left: 90.1 right: 0 top: 641.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/511824e50f7c4849.png") }
    Image{ width: 27.5 height: 30.0 margin: Inset{left: 117.8 right: 0 top: 641.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/511824e50f7c4849.png") }
    RoundedView{ width: 30.0 height: 30.0 margin: Inset{left: 145.4 right: 0 top: 641.5 bottom: 0} draw_bg.color: #ffffff66 draw_bg.border_radius: 15.0 }
    ...
    RoundedView{ width: 48.8 height: 19.2 margin: Inset{left: 67.5 right: 0 top: 712.9 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 28.4 height: 12.4 margin: Inset{left: 77.7 right: 0 top: 716.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/1d40708b4c7894c2.png") }
    View{ width: 196.8 height: 14.0 margin: Inset{left: 128.6 right: 0 top: 718.5 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "follow Oluchi" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    View{ width: 150.6 height: 21.0 margin: Inset{left: 35.0 right: 0 top: 553.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Interaction Designer" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 } } }
    View{ width: 315.0 height: 51.5 margin: Inset{left: 35.0 right: 0 top: 583.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fill height: Fit text: "Zombie buff. Hipster-friendly organizer. Internet geek. Introvert. Typical beer advocate." draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 line_spacing: 2.0 } } }
    View{ width: 201.9 height: 41.0 margin: Inset{left: 35.0 right: 0 top: 515.5 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Oluchi Mazi" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-SemiBold.ttf") asc: 0.0 desc: 0.0 } } font_size: 18.6 } } }
