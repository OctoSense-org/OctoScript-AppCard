...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 3.7 height: 7.5 margin: Inset{left: 188.9 right: 0 top: 670.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/12d3f0632fe27039.png") }
    ...
    Image{ width: 15.1 height: 18.1 margin: Inset{left: 187.9 right: 0 top: 301.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/08651c61844ac69a.png") }
    Image{ width: 16.1 height: 10.2 margin: Inset{left: 168.4 right: 0 top: 301.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/70e913f145d8e834.png") }
    Image{ width: 20.6 height: 12.1 margin: Inset{left: 179.1 right: 0 top: 304.6 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/c757f48213a48dfc.png") }
    Image{ width: 6.4 height: 15.7 margin: Inset{left: 169.6 right: 0 top: 307.4 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/6902ea750156338f.png") }
    Image{ width: 5.7 height: 7.8 margin: Inset{left: 190.9 right: 0 top: 309.4 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/035c86f621d739a5.png") }
    Image{ width: 15.3 height: 14.9 margin: Inset{left: 172.7 right: 0 top: 307.6 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/70bdb0ae48eb9b70.png") }
    Image{ width: 16.2 height: 11.8 margin: Inset{left: 175.7 right: 0 top: 310.7 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/8f7881e34d1aa4f1.png") }
    Image{ width: 8.1 height: 5.1 margin: Inset{left: 182.7 right: 0 top: 313.7 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/1e23c9d51fc8a797.png") }
    Image{ width: 5.8 height: 4.2 margin: Inset{left: 181.8 right: 0 top: 316.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/f0e369fdc97bb5fc.png") }
    Image{ width: 2.6 height: 16.3 margin: Inset{left: 179.8 right: 0 top: 321.1 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/531858e62641a9f1.png") }
