...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 147.0 height: 47.5 margin: Inset{left: 114.0 right: 0 top: 358.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/7c33332f6f07e6bf.png") }
    ...
    Image{ width: 20.0 height: 22.0 margin: Inset{left: 272.5 right: 0 top: 360.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/d003310ec777f78b.png") }
    ...
    Image{ width: 29.5 height: 12.3 margin: Inset{left: 81.5 right: 0 top: 605.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/296bd8d96c6bca8d.png") }
    ...
    Image{ width: 14.8 height: 16.2 margin: Inset{left: 88.3 right: 0 top: 538.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/4923a505960f866c.png") }
    ...
    Image{ width: 25.4 height: 15.8 margin: Inset{left: 83.4 right: 0 top: 472.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/16a1abe42c2674e8.png") }
