...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/79735f6db309ff56.png") }
    ...
    Image{ width: 260.5 height: 13.5 margin: Inset{left: 58.0 right: 0 top: 565.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/b502cb2f73738d78.png") }
    ...
    Image{ width: 79.0 height: 25.0 margin: Inset{left: 187.5 right: 0 top: 527.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/098f603dc7e52a8a.png") }
    ...
    Image{ width: 5.0 height: 9.5 margin: Inset{left: 185.0 right: 0 top: 697.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/a20dbbaae603da42.png") }
    ...
    Image{ width: 7.7 height: 11.3 margin: Inset{left: 48.8 right: 0 top: 611.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/71aa0bd9ea367cc6.png") }
    Image{ width: 7.7 height: 11.3 margin: Inset{left: 46.5 right: 0 top: 615.1 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/ac2d2da55fe5953f.png") }
    ...
    Image{ width: 7.7 height: 10.8 margin: Inset{left: 254.8 right: 0 top: 613.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/9c3d3e07896fb2ce.png") }
    Image{ width: 6.3 height: 8.8 margin: Inset{left: 253.4 right: 0 top: 617.6 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/e2a687d16a96c6f0.png") }
    ...
    Image{ width: 4.7 height: 6.0 margin: Inset{left: 29.9 right: 0 top: 48.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/49e3bcd184a0e01e.png") }
    Image{ width: 4.7 height: 6.0 margin: Inset{left: 29.9 right: 0 top: 48.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/581194ee8b8bf685.png") }
