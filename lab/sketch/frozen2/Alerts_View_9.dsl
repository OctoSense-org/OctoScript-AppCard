...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 150.3 height: 85.2 margin: Inset{left: 92.7 right: 0 top: 366.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/72e4624d12230183.png") }
    Image{ width: 9.7 height: 33.0 margin: Inset{left: 182.7 right: 0 top: 433.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/663a032fda44258e.png") }
    Image{ width: 68.5 height: 44.0 margin: Inset{left: 158.4 right: 0 top: 393.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/d45ede602ebd4e03.png") }
    Image{ width: 33.0 height: 44.0 margin: Inset{left: 141.8 right: 0 top: 393.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/b7b389d2ac136a73.png") }
    Image{ width: 42.7 height: 5.0 margin: Inset{left: 132.5 right: 0 top: 432.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/1ec332e0cde12f0c.png") }
    Image{ width: 25.4 height: 37.0 margin: Inset{left: 204.1 right: 0 top: 374.6 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/2483184b1dd52257.png") }
    Image{ width: 23.7 height: 14.8 margin: Inset{left: 151.5 right: 0 top: 411.4 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/9ea85b8560a62ebb.png") }
    Image{ width: 23.7 height: 14.8 margin: Inset{left: 151.5 right: 0 top: 406.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/d6367a2465f7b589.png") }
