// FROZEN compile of ⟶ [Account] Failed Overlay — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 143.6 height: 70.1 margin: Inset{left: 114.8 right: 0 top: 388.6 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/6edd7bc036753ba9.png") }
    Image{ width: 58.2 height: 60.0 margin: Inset{left: 168.8 right: 0 top: 405.9 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/a4f2b3af30b6d7b9.png") }
    Image{ width: 54.0 height: 54.5 margin: Inset{left: 174.5 right: 0 top: 410.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3b5a7b0b25d0037d.png") }
    Image{ width: 88.7 height: 63.4 margin: Inset{left: 143.3 right: 0 top: 403.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3c6c67de7d8904a5.png") }
    ...
    View{ width: 310.0 height: 53.0 margin: Inset{left: 37.5 right: 0 top: 579.5 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fill height: Fit text: "Your password cannot be changed for an unknown reason" draw_text.color: #6c7b8aff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Regular.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.4 line_spacing: 2.0 } } }
    View{ width: 300.5 height: 55.0 margin: Inset{left: 71.5 right: 0 top: 520.5 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Your password cannot be changed" draw_text.color: #140f26ff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-SemiBold.ttf") asc: 0.0 desc: 0.0 } } font_size: 12.4 } } }
