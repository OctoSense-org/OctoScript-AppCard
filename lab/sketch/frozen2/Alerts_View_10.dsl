...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 46.8 height: 24.0 margin: Inset{left: 70.2 right: 0 top: 664.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 34.1 height: 14.0 margin: Inset{left: 77.0 right: 0 top: 669.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/716973fd55ae9087.png") }
    View{ width: 188.8 height: 16.0 margin: Inset{left: 128.7 right: 0 top: 671.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Allow camera" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
    ...
    Image{ width: 143.6 height: 75.1 margin: Inset{left: 114.8 right: 0 top: 371.1 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/ad9f5f0576dfd44f.png") }
    Image{ width: 64.8 height: 70.0 margin: Inset{left: 166.0 right: 0 top: 377.3 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3905df64416b47e7.png") }
    Image{ width: 51.0 height: 50.0 margin: Inset{left: 173.0 right: 0 top: 383.8 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/2a36652e87dda26a.png") }
    Image{ width: 24.1 height: 10.1 margin: Inset{left: 175.2 right: 0 top: 408.5 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/fef30f23ec6e0b3e.png") }
    Image{ width: 30.4 height: 15.1 margin: Inset{left: 192.6 right: 0 top: 410.1 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/bba0f80379e7f941.png") }
    Image{ width: 64.8 height: 70.0 margin: Inset{left: 142.4 right: 0 top: 397.2 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3905df64416b47e7.png") }
    Image{ width: 51.0 height: 50.0 margin: Inset{left: 149.4 right: 0 top: 403.7 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/2a36652e87dda26a.png") }
    ...
    Image{ width: 24.1 height: 10.1 margin: Inset{left: 151.6 right: 0 top: 428.4 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/fef30f23ec6e0b3e.png") }
    Image{ width: 30.4 height: 15.1 margin: Inset{left: 169.1 right: 0 top: 430.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/5ea8507a0bc68041.png") }
