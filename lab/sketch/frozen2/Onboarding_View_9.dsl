// FROZEN compile of ⟶ [Onboarding] View #9 — spec2dsl.py.
...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    RoundedView{ width: 375.0 height: 485.0 margin: Inset{left: 0.0 right: 0 top: 327.0 bottom: 0} draw_bg.color: #ffffff00 draw_bg.color_2: #000000ff draw_bg.gradient_angle: -18.0 }
    Image{ width: 375.0 height: 485.0 margin: Inset{left: 0.0 right: 0 top: 327.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/15c85866325664a2.png") }
    Image{ width: 147.0 height: 47.5 margin: Inset{left: 114.0 right: 0 top: 378.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/e56930c20dd42527.png") }
    RoundedView{ width: 20.0 height: 17.6 margin: Inset{left: 272.5 right: 0 top: 380.0 bottom: 0} draw_bg.color: #140f2693 draw_bg.border_radius: 2.2 }
    RoundedView{ width: 3.5 height: 8.8 margin: Inset{left: 272.5 right: 0 top: 393.2 bottom: 0} draw_bg.color: #140f2693 }
    Image{ width: 20.0 height: 22.0 margin: Inset{left: 272.5 right: 0 top: 380.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3a24618db34b5d26.png") }
    View{ width: 18.6 height: 15.7 margin: Inset{left: 274.1 right: 0 top: 383.9 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "UI" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 5.6 } } }
    View{ width: 107.8 height: 16.0 margin: Inset{left: 144.8 right: 0 top: 757.0 bottom: 0} flow: Down align: Align{x: 0.5} Label{ width: Fit height: Fit text: "Skip this step" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 7.8 } } }
    RoundedView{ width: 300.0 height: 50.0 margin: Inset{left: 37.5 right: 0 top: 692.0 bottom: 0} draw_bg.color: #4c5fefff draw_bg.border_radius: 25.0 }
    RoundedView{ width: 48.0 height: 24.0 margin: Inset{left: 69.5 right: 0 top: 705.0 bottom: 0} draw_bg.color: #1c8ff800 }
    Image{ width: 33.2 height: 14.2 margin: Inset{left: 77.3 right: 0 top: 710.2 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/7be1f43ae5362d33.png") }
    View{ width: 193.6 height: 16.0 margin: Inset{left: 129.5 right: 0 top: 712.0 bottom: 0} flow: Down align: Align{x: 0.0} Label{ width: Fit height: Fit text: "Join now" draw_text.color: #ffffffff draw_text.text_style: TextStyle{ font_family: FontFamily{ latin := FontMember{ res: crate_resource("makepad_widgets:resources/Montserrat-Medium.ttf") asc: 0.0 desc: 0.0 } } font_size: 8.1 } } }
