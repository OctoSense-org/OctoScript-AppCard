// FROZEN compile of ⟶ [Shop] View #11 — spec2dsl.py.
// A poster, not an app: no roles, no data, no theme.
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #f5f6f7ff
    RoundedView{ width: 375.0 height: 812.0 margin: Inset{left: 0.0 right: 0 top: 0.0 bottom: 0} draw_bg.color: #d8d8d8ff }
    RoundedView{ width: 375.0 height: 375.0 margin: Inset{left: 0.0 right: 0 top: 437.0 bottom: 0} draw_bg.color: #140f2600 draw_bg.color_2: #000000ff }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 162.5 right: 0 top: 756.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 208.0 right: 0 top: 756.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 4.5 height: 4.5 margin: Inset{left: 192.5 right: 0 top: 756.0 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.2 }
    RoundedView{ width: 5.5 height: 5.5 margin: Inset{left: 177.0 right: 0 top: 755.5 bottom: 0} draw_bg.color: #ffffffff draw_bg.border_radius: 2.8 }
    RoundedView{ width: 30.0 height: 30.0 margin: Inset{left: 325.0 right: 0 top: 65.0 bottom: 0} draw_bg.color: #f4f6f9ff draw_bg.border_radius: 15.0 }
    RoundedView{ width: 6.5 height: 6.5 margin: Inset{left: 336.8 right: 0 top: 76.8 bottom: 0} draw_bg.color: #1c8ff800 }
