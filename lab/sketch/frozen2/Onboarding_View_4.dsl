...
View{ flow: Overlay width: 375 height: 812 draw_bg.color: #ffffffff
    ...
    Image{ width: 9.8 height: 10.9 margin: Inset{left: 86.9 right: 0 top: 666.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/be6ffe519c8d1914.png") }
    Image{ width: 22.7 height: 7.0 margin: Inset{left: 80.4 right: 0 top: 673.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/069f30617a2bbc2e.png") }
    ...
    Image{ width: 270.0 height: 538.0 margin: Inset{left: 52.5 right: 0 top: -51.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/d78934262b2f688e.png") }
    Image{ width: 15.3 height: 497.0 margin: Inset{left: 72.5 right: 0 top: -34.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/f479f18bedccecf6.png") }
    Image{ width: 15.3 height: 494.0 margin: Inset{left: 286.5 right: 0 top: -34.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/3242ab2319a2f577.png") }
    Image{ width: 15.3 height: 235.0 margin: Inset{left: 178.8 right: 0 top: 359.1 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/fb0b7b63f7a29469.png") }
    Image{ width: 15.3 height: 243.0 margin: Inset{left: 179.5 right: 0 top: -158.0 bottom: 0} fit: ImageFit.Stretch src: http_resource("http://127.0.0.1:8787/_icons/a5db2e2ab96a2a5f.png") }
