...
| Component adaptation | [`app-recipes.json`](../splash-makepad/components/l0/native/app-recipes.json) and [`l0_kit_components.rs`](../app/app/src/app/l0_kit_components.rs) adapt supported weather/news/stock structures to source-backed kit components | Selection is coupled to the card's theme and recognized app/tree patterns; independent per-component kit selection is not established |
