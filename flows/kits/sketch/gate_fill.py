...
def _mask(path):
    ...
    with Image.open(path) as source:
        ...
        im=Image.alpha_composite(Image.new('RGBA',source.size,'white'),rgba)
        im=im.convert('RGB').resize((120, 300),Image.Resampling.BILINEAR)
